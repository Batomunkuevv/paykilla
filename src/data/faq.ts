export const faq = [
    ...
    {
        question: "How does<br> PK work?",
        answer: "When a&nbsp;customer selects a&nbsp;cryptocurrency at&nbsp;the checkout stage, PK&nbsp;generates a&nbsp;unique payment address for the transaction. The customer sends the exact amount from his wallet and&nbsp;PK verifies correctness of&nbsp;the transaction. Business can choose to&nbsp;receive payments in&nbsp;multiple cryptocurrencies or&nbsp;automatically convert to&nbsp;one preferred currency, with&nbsp;PK dashboard providing real-time monitoring and reporting.",
    },
    {
        question: "Is&nbsp;it&nbsp;safe<br> to&nbsp;use&nbsp;PK?",
        answer: "Yes, PK&nbsp;implements advanced security measures including advanced encryption, multi-signature authentication and real-time fraud detection systems. Unlike traditional payment systems that are vulnerable to&nbsp;data breaches, PK&rsquo;s decentralised architecture minimises exposure to&nbsp;common security threats.",
    },
    {
        question: "How to&nbsp;start<br> using the service?",
        answer: "Getting started with&nbsp;PK requires you to&nbsp;create an&nbsp;account for your business. Once registered, customise your payment preferences and integrate using the API or&nbsp;use the out-of-the-box widget solution. This is&nbsp;enough to&nbsp;start accepting cryptocurrency payments without connection fees or&nbsp;technical hurdles.",
    },
    {
        question: "Does the service<br> charge a&nbsp;connection fee?",
        answer: "No, PK&nbsp;does not charge any connection fees, unlike many traditional payment processors and other cryptocurrency gateways. This zero fee policy makes accepting cryptocurrency affordable for businesses of&nbsp;any size with no&nbsp;upfront costs or&nbsp;hidden setup fees.",
    },
    {
        question: "How do&nbsp;businesses integrate cryptocurrency into their existing payment system?",
        answer: "PK&nbsp;integrates seamlessly along with your existing payment methods via special plugins or&nbsp;APIs. The integration adds cryptocurrency as&nbsp;a&nbsp;payment option without changing the existing payment process, while the dashboard consolidates reporting across all payment methods.",
    },
];
