...
export const SolutionsSection = () => {
  ...
  useEffect(() => {
    ...
    const handleSwipeGesture = () => {
      ...
      if (Math.abs(deltaX) > minSwipeDistance) {
        ...
        if (deltaX > 0) {
          const nextTab = section.querySelector(
            ".swiper-slide-next button"
          ) as HTMLElement;

          nextTab.click();
        } else {
          const prevTab = section.querySelector(
  ...
  return (
    <section
      ref={sectionRef}
      id="solutions"
      className="pt-[200px] section xl:pt-[167px] md:pt-[110px] sm:pt-[90px]"
    >
                ...
                return (
                  <SwiperSlide key={index} className="sm:!w-fit">
                    <button
                      ...
                      className={clsx(
                        "pl-[6px] relative w-full text-left 2xl:pl-[3px] md:pl-0"
                      )}
                    >
                      <span
                        className={clsx(
                          ...
                          "sm:translate-y-0 sm:opacity-100 sm:text-[18px] sm:leading-[194.44%]",
                          {
                            ...
                            "translate-y-[-36px] 2xl:translate-y-[-26px]":
                              isPrev,
