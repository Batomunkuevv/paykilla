                ...
                >
                    ...
                    <SwiperSlide className="min-md:!w-full sm:max-w-[320px]">
                        ...
                        >
                            <div className="absolute inset-[-3px] z-0 opacity-0 transition-all duration-500 group-hover:opacity-100 sm:opacity-100">
                                <picture>
                                    <source srcSet="/images/homepage/how-it-works/02-360.png" media="(max-width: 767px)" />
                                    <source srcSet="/images/homepage/how-it-works/02-768.png" media="(max-width: 991px)" />
                                    <source srcSet="/images/homepage/how-it-works/02-1440.png" media="(max-width: 1719px)" />
                                    <img
                            ...
                            <div className="absolute inset-0 z-[1] pointer-events-none select-none sm:hidden">
                                <div
                                    className={clsx(
                                        "flex w-full h-full text-transparent text-[485px] font-medium leading-none",
                                        "bg-[url(/images/homepage/how-it-works/02.png)] bg-cover bg-center bg-clip-text",
                                        "xl:bg-[url(/images/homepage/how-it-works/02-1440.png)] xl:text-[384px]",
                                        "tb:bg-[url(/images/homepage/how-it-works/02-768.png)] tb:text-[250px] tb:font-bold"
                                    )}
                                >
                                    <span
                                        className={clsx(
