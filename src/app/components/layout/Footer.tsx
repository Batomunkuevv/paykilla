...
export const Footer = () => {
  ...
  return (
    <footer
      ref={footerRef}
      className="site-footer pt-[100px] bg-black overflow-hidden xl:pt-[80px] sm:pt-[60px]"
    >
      <div className="container">
        ...
        >
          <div className="sm:grid sm:grid-cols-2 sm:max-w-[90%] sm:gap-[39px]">
            <p className="text-t-white mb-[42px] xl:mb-[45px] sm:mb-[30px] whitespace-nowrap">
              &copy;&nbsp;{currentYear} PayKilla.
              <br /> All rights reserved.
            </p>
           <div>
             <p className="font-bold leading-[36px] text-t-white mb-[3px] sm:hidden ">
              Get in touch with us
            </p>
            <ul className="[&_*]:text-t-white">
              <li className="mb-[5px] xl:mb-[9px] sm:mb-[1px]">
                <p className="grid grid-cols-[38px_auto] xl:grid-cols-[29px_auto] tb:grid-cols-[26px_auto] sm:grid-cols-[23px_auto]">
              ...
              <li>
                <a
                  className="grid grid-cols-[38px_auto] [&:hover_.link-text]:text-orange transition-all xl:grid-cols-[29px_auto] tb:grid-cols-[26px_auto] sm:grid-cols-[23px_auto]"
                  target="_blank"
                ...
                >
                  ...
                  <span className="link-text transition-all whitespace-nowrap">
                    Contact us in TG
                  </span>
                </a>
              </li>
          ...
          />
          <Button
            href={process.env.NEXT_PUBLIC_BUTTONS_GET_STARTED_URL}
            className="xl:mt-[7px] tb:mt-0"
          >
            GET STARTED
          </Button>
        </div>
      ...
      <div className="max-w-[1920px] mx-auto">
        ...
        >
          <Logo
            type="footer"
            className="mb-[-2.7%] ml-[2px] w-full xl:ml-0 sm:mb-[-2.8%]"
          />
        </Animated.Div>
      </div>
    </footer>
